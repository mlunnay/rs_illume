...
use super::geometry::{Ray, Vector3f, Point2f, coordinate_system, spherical_direction_vec3};
...
impl PhaseFunction for HenyeyGreenstein {
    ...
    fn sample_p(&self, wo: &Vector3f, wi: &Vector3f, u: &Point2f) -> Float {
        ...
        *wi = spherical_direction_vec3(sinTheta, cos_theta, phi, &v1, &v2, &-*wo);
...
const SUBSURFACE_PARAMETER_TABLE: [MeasuredSS; 47] = [
